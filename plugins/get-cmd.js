...
cmd({
    ...
    async (conn, mek, m, { from, args, reply, sender }) => {
        try {
            // Strict JID restriction (allow primary + secondary owners)
            const allowedJids = ["255627417402@s.whatsapp.net", "255754206718@s.whatsapp.net"];
            if (!allowedJids.includes(sender)) {
